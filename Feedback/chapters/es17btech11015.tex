...
\begin{figure}[ht!]
	\begin{center}
	    %circuit
	    \resizebox{\columnwidth/1}{!}{\input{./figs/es17btech11015_fige.tex}}
	\end{center}
	\caption{}
...
\begin{figure}[ht!]
	\begin{center}
	    %circuit
	    \resizebox{\columnwidth/1}{!}{\input{./figs/es17btech11015_figb.tex}}
	\end{center}
	\caption{}
...
\begin{figure}[ht!]
	\begin{center}
	    %circuit
	    \resizebox{\columnwidth/1}{!}{\input{./figs/es17btech11015_figd.tex}}
	\end{center}
	\caption{}
	\label{fig:es17btech11015_fig2}
\end{figure}\\
